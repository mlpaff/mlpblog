...
An additional benefit of using a logistic regression for this problem was that I could extract the important features (those with the highest absolute coefficient values). 

```{r feat-importances, fig.cap="Important features from the model trained on the genotype and clinic data", echo=FALSE, message=FALSE}
...
```{r overlapping diseases, fig.cap="Patient counts for diseases that occurred concurrently with the opioid dependence diagnosis", echo=FALSE, message=FALSE}
