...
In diving into the genetic sequencing data, I found that sequencing coverage was highly skewed (figure 1).

```{r genes, fig.cap="Distribution of gene sequencing coverage", echo=FALSE, message=FALSE, fig.height=5}
...
```{r confusion, fig.cap="Confusion matrices for **A.** ", echo=FALSE, message=FALSE, fig.height = 4}
...
plot_grid(gene_conf, clinic_conf, labels = c("A", "B"))
```
